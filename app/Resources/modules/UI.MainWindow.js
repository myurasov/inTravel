...
//    tableView.setFooterView(footerView);
  ...
  function shareLocation()
  {
    var optionsDialog = Titanium.UI.createOptionDialog({
      title: 'Share',
      options: ["Facebook", "Contact", "Email", "SMS", "Cancel"],
      cancel: 4
    });
    ...
    optionsDialog.addEventListener("click", function(e){
      if (e.index == 0)
      {
        Ti.Facebook.appid = '533603513318623';
        Ti.Facebook.permissions = ['publish_stream']; // Permissions your app needs

        Ti.Facebook.addEventListener('login', function(e) {
            if (e.success) {

              Ti.Facebook.requestWithGraphPath('me/feed', {message: Project.application.getLink()},
              "POST", function(e) {
                if (e.success) {
...
//        Ti.Facebook.logout();
  ...
  function resetLink()
  {
    ...
    alertBox.addEventListener("click", function(e){
      ...
      {
        // new channel
        Project.Config.set('channel', Project.Utils.createUID(3)).save();
